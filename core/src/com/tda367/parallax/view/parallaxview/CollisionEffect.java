...
public class CollisionEffect implements CollisionObserver{
    ...
    public void respondToCollision(CollisionResult collisionResult) {
        ...
        Vector3f explosionPoint = collisionResult.getContactPoint();
        CollidableType first = collisionResult.getFirst().getCollidableType();
        CollidableType second = collisionResult.getSecond().getCollidableType();
    ...
    private void createAscend(Vector3f position) {
        RenderableParticleEffect ascendEffect = new RenderableParticleEffect(ParticleEffectType.ASCEND);
    ...
    private void createExplosion(Vector3f explosionPoint) {
        RenderableParticleEffect explosionParticle = new RenderableParticleEffect(ParticleEffectType.EXPLOSION);
    ...
    public void render(){
        ...
        for (RenderableParticleEffect particleExplosion : activeEffects) {
