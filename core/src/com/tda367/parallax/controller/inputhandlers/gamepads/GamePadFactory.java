...
public final class GamePadFactory {
    ...
    public static GamePad getGamePad(String gamePadName){
        ...
        if(gamePadNameLowerCase.contains("playstation") && gamePadNameLowerCase.contains("3")) {
            return new com.tda367.parallax.controller.inputhandlers.gamepads.Playstation3GamePad();
            ...
            return new com.tda367.parallax.controller.inputhandlers.gamepads.AndroidGamePad();
        } else {
            return null;
